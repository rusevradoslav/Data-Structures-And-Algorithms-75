...
public class ConstructBinaryTreeFromInorderAndPostorderTraversalTest {
    ...
    @Test
    @DisplayName("Example 1: inorder=[9,3,15,20,7], postorder=[9,15,7,20,3] → tree rooted at 3")
    ...
    @Test
    @DisplayName("Example 2: inorder=[-1], postorder=[-1] → single node tree")
    ...
    @Test
    @DisplayName("Left-skewed tree: inorder=[1,2,3], postorder=[1,2,3] → each node has only left child")
    ...
    @Test
    @DisplayName("Right-skewed tree: inorder=[1,2,3], postorder=[3,2,1] → each node has only right child")
